...
- **Просмотр трейлеров (через встроенный YouTube-плеер)**
...
- **Vue Lite YouTube Embed** — плагин для воспроизведения видео
...
информация о сессии.
3) При выполнении к запросам автоматически добавляется cookie (credentials: include).
...
**Линтинг JS/TS и Vue-файлов:**

   ```
   $ npm run lint
   ```
**Проверка и форматирование стилей:**
...
Настройки в файлах `.prettierrc.json` и `.stylelintrc.cjs`.
